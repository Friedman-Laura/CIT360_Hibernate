...
public class CIT360_Hibernate {
    ...
    public static void main(String[] args) {
        ...
        for (pojos.Song songs : slist) {
            System.out.println(songs.getId() + ", " + songs.getName() + ", "
                                + songs.getAlbum() + ", " + songs.getGenre());
        }
        ...
        System.out.println(oneSong.getId() + ", " + oneSong.getName() + ", "
                + oneSong.getAlbum() + ", " + oneSong.getGenre());
